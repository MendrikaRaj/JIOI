-------------------------------------------DROP-------------------------------------------
DROP VIEW IF EXISTS V_MOUVEMENT_DETAIL;
...
CREATE OR REPLACE VIEW V_MOUVEMENT_DETAIL AS
    SELECT
        M.DATE,
        C.TYPE,
        CD.CODE AS CODE_CATEGORIE,
        M.MONTANT,
        D.CODE AS CODE_DISCIPLINE
    FROM
        MOUVEMENTS M
        JOIN CATEGORIE_DETAILS CD
        ON CD.ID=M.CATEGORIEDETAILID JOIN CATEGORIES C
        ON C.ID=CD.CATEGORIEID
        JOIN DISCIPLINES D
        ON D.ID=M.DISCIPLINEID;
