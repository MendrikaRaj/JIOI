            ...
            <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0"
                ...
                <div class="container-fluid d-flex flex-column p-0"><a
                    ...
                    <ul class="navbar-nav text-light" id="accordionSidebar" style="color: rgb(0,0,0);">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="{{ url('/site') }}"
            ...
            <div class="d-flex flex-column" id="content-wrapper">
                <div id="content">
                    ...
                    <section class="contact-clean" style="background: rgba(241,247,252,0);">
                        <form method="post" action="{{ route('enregistrer', ['modelName' => 'Site']) }}"
                            ...
                            @endif
                            <h2 class="text-center">Ajouter de nouveau Site</h2>
                            <div class="mb-3"><label class="form-label">Nom du site</label><input
                                    class="form-control" type="text" name="nom" placeholder="ex: Mahamasina">
                                @error('nom')
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: left;">
                                                            <button class="btn btn-link" type="button"
                                                                ...
                                                                data-bs-target="#modification-modal-{{ $sites->id }}">
                                                                Modifier
                                                            </button>
                                                        </td>
                                                        <td style="text-align: left;">
                                                            <button class="btn btn-link" type="button"
                                                                ...
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#suppression-modal-{{ $sites->id }}">
                                                                Supprimer
                                                            </button>
                                                        </td>
                                                    </tr>
                                                    <div class="modal fade" role="dialog" tabindex="-1"
                                                        id="modification-modal-{{ $sites->id }}">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content"
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('modifier', ['modelName' => 'Site', 'id' => $sites->id]) }}"
                                                    ...
                                                    <div class="modal fade" role="dialog" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content"
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="POST"
                                                                        action="{{ route('supprimer', ['modelName' => 'Site', 'id' => $sites->id]) }}">
                                                                        @csrf
                                                                        @if (Session::has('success'))
                                                                            <div class="alert alert-success">
                                                                                {{ Session::get('success') }}</div>
