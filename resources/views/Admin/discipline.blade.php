            ...
            <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0"
                ...
                <div class="container-fluid d-flex flex-column p-0"><a
                    ...
                    <ul class="navbar-nav text-light" id="accordionSidebar" style="color: rgb(0,0,0);">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="{{ url('/discipline') }}"
            ...
            <div class="d-flex flex-column" id="content-wrapper">
                <div id="content">
                    ...
                    <section class="contact-clean" style="background: rgba(241,247,252,0);">
                        <form method="post" action="{{ route('enregistrer', ['modelName' => 'Discipline']) }}"
                            ...
                            @endif
                            <h2 class="text-center">Ajouter des disciplines</h2>
                            <div class="mb-3"><label class="form-label">Nom de la discipline</label><input
                                    class="form-control" type="text" name="nom"
                                    placeholder="Ex : Basket-ball">
                                @error('nom')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="mb-3"><label class="form-label">Type de la discipline</label><select
                                    class="form-select" name="type">
                                    <optgroup label="Individualité">
                                            ...
                                            <tbody>
                                                @foreach ($discipline as $disciplines)
                                                    <tr>
                                                        ...
                                                        @if ($disciplines->type == 0)
                                                            <td>Individuelle</td>
                                                        @else
                                                            <td>Collectif</td>
                                                        @endif
                                                        <td>{{ $disciplines->code }}</td>
                                                        <td style="text-align: left;">
                                                            <button class="btn btn-link" type="button"
                                                                style="border: none; color: blue; text-decoration: underline;"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#modification-modal-{{ $disciplines->id }}">
                                                                Modifier
                                                            </button>
                                                        </td>
                                                        <td style="text-align: left;">
                                                            <button class="btn btn-link" type="button"
                                                                ...
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#suppression-modal-{{ $disciplines->id }}">
                                                                Supprimer
                                                            </button>
                                                        </td>
                                                    </tr>
                                                    <div class="modal fade" role="dialog" tabindex="-1"
                                                        id="modification-modal-{{ $disciplines->id }}">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content"
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('modifier', ['modelName' => 'Discipline', 'id' => $disciplines->id]) }}"
                                                                        ...
                                                                        <div class="mb-3"><label
                                                                                class="form-label">Type</label><select
                                                                                class="form-select" name="type">
                                                                                <optgroup label="Type de discipline">
                                                                                    <option
                                                                                        value="0"{{ $disciplines->type == 0 ? 'selected' : '' }}>
                                                                                        Individuelle
                                                                                    </option>
                                                                                    <option
                                                                                        value="1"{{ $disciplines->type == 1 ? 'selected' : '' }}>
                                                                                        Collectif
                                                                                    </option>
                                                                                </optgroup>
                                                                            </select>
                                                    ...
                                                    <div class="modal fade" role="dialog" tabindex="-1"
                                                        id="suppression-modal-{{ $disciplines->id }}">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content"
                                                                style="background-color: white">
                                                                <div class="modal-header" style="text-align: left;">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="POST"
                                                                        action="{{ route('supprimer', ['modelName' => 'Discipline', 'id' => $disciplines->id]) }}">
                                                                        @csrf
                                                                        @if (Session::has('success'))
                                                                            <div class="alert alert-success">
                                                                                {{ Session::get('success') }}</div>
