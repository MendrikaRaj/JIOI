            ...
            <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0"
                ...
                <div class="container-fluid d-flex flex-column p-0"><a
                        ...
                        <div class="sidebar-brand-icon rotate-n-0"><img class="circular-icon" src="assets/img/JIOI.png"
                                alt="Image" style="width: 40px; height: 40px; color: #5D87FF;"></div>
                    ...
                    <ul class="navbar-nav text-light" id="accordionSidebar" style="color: rgb(0,0,0);">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="{{ url('/pays') }}"
            ...
            <div class="d-flex flex-column" id="content-wrapper">
                <div id="content">
                    ...
                    <section class="contact-clean" style="background: rgba(241,247,252,0);">
                        <form method="post" action="{{ route('enregistrer', ['modelName' => 'Pays']) }}"
                            ...
                            @endif
                            <h2 class="text-center">Ajouter des pays</h2>
                            <div class="mb-3"><label class="form-label">Nom du pays</label><input
                                    class="form-control" type="text" name="nom" placeholder="pays">
                                @error('nom')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="mb-3"><label class="form-label">Drapeau</label><input class="form-control"
                        ...
                        <div class="container">
                            <div class="card shadow">
                                <div class="card-header py-3">
                                    <p class="text-primary m-0 fw-bold">Liste des pays</p>
                                </div>
                                        ...
                                        <table class="table my-0" id="dataTable">
                                            ...
                                            <tbody>
                                                @foreach ($pays as $payss)
                                                    <tr>
                                                        <td><img src="{{ str_replace('public', 'storage', $payss->photo) }}"
                                                                alt="Image">
                                                        </td>
                                                        <td>{{ $payss->nom }}</td>
                                                        <td style="text-align: left;">
                                                            <button class="btn btn-link" type="button"
                                                                ...
                                                                data-bs-target="#modification-modal-{{ $payss->id }}">
                                                                Modifier
                                                            </button>
                                                        </td>
                                                        <td style="text-align: left;">
                                                            <button class="btn btn-link" type="button"
                                                                ...
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#suppression-modal-{{ $payss->id }}">
                                                                Supprimer
                                                            </button>
                                                        </td>
                                                    </tr>
                                                    <div class="modal fade" role="dialog" tabindex="-1"
                                                        id="modification-modal-{{ $payss->id }}">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content"
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('modifier', ['modelName' => 'Pays', 'id' => $payss->id]) }}"
                                                    ...
                                                    <div class="modal fade" role="dialog" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content"
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="POST"
                                                                        action="{{ route('supprimer', ['modelName' => 'Pays', 'id' => $payss->id]) }}">
                                                                        @csrf
                                                                        @if (Session::has('success'))
                                                                            <div class="alert alert-success">
                                                                                {{ Session::get('success') }}</div>
