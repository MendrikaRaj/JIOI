            ...
            <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0"
                ...
                <div class="container-fluid d-flex flex-column p-0"><a
                    ...
                    <ul class="navbar-nav text-light" id="accordionSidebar" style="color: rgb(0,0,0);">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="{{ url('/calendrier') }}"
            ...
            <div class="d-flex flex-column" id="content-wrapper">
                <div id="content">
                    ...
                    <section class="contact-clean" style="background: rgba(241,247,252,0);">
                        <form method="post" action="{{ route('enregistrer', ['modelName' => 'Calendrier']) }}"
                            ...
                            @endif
                            <h2 class="text-center">Calendrier des matchs</h2>
                            <div class="mb-3"><label class="form-label">Date</label><input class="form-control"
                                    type="datetime-local" name="date">
                                @error('date')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="mb-3"><label class="form-label">Site</label><select class="form-select"
                                    name="siteid">
                                    <optgroup label="Site du match">
                                        @foreach ($site as $sites)
                                            <option value="{{ $sites->id }}">{{ $sites->nom }}</option>
                                        @endforeach
                                    </optgroup>
                                </select></div>
