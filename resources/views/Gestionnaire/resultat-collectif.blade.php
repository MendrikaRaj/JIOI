            ...
            <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0"
                ...
                <div class="container-fluid d-flex flex-column p-0"><a
                    ...
                    <ul class="navbar-nav text-light" id="accordionSidebar" style="color: rgb(0,0,0);">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="{{ url('/resultat_collectif') }}"
            ...
            <div class="d-flex flex-column" id="content-wrapper">
                <div id="content">
                    ...
                    <section class="contact-clean" style="background: rgba(241,247,252,0);">
                        <form method="post" action="{{ route('enregistrer', ['modelName' => 'Resultat']) }}"
                            ...
                            @endif
                            <h2 class="text-center">Enregistrement des résultats collectifs</h2>
                                        ...
                                        <table class="table my-0" id="dataTable">
                                            ...
                                            <tbody>
                                                @foreach ($resultat as $resultats)
                                                    <tr>
                                                        <td>{{ $resultats->rang }}</td>
                                                        @foreach ($pays as $payss)
                                                            @if ($resultats->paysid == $payss->id)
                                                                <td>{{ $payss->nom }}</td>
                                                            @endif
                                                        @endforeach
                                                        @foreach ($discipline as $disciplines)
                                                            @if ($resultats->disciplineid == $disciplines->id)
                                                        ...
                                                        <td style="text-align: left;">
                                                            <button class="btn btn-link" type="button"
                                                                ...
                                                                data-bs-target="#modification-modal-{{ $resultats->id }}">
                                                                Modifier
                                                            </button>
                                                        </td>
                                                        <td style="text-align: left;">
                                                            <button class="btn btn-link" type="button"
                                                                ...
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#suppression-modal-{{ $resultats->id }}">
                                                                Supprimer
                                                            </button>
                                                        </td>
                                                    </tr>
                                                    <div class="modal fade" role="dialog" tabindex="-1"
                                                        id="modification-modal-{{ $resultats->id }}">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content"
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('modifier', ['modelName' => 'Resultat', 'id' => $resultats->id]) }}"
                                                                        ...
                                                                        <div class="mb-3"><label
                                                                                ...
                                                                                <optgroup label="pays de l'athlète">
                                                                                    @foreach ($pays as $payss)
                                                                                        <option
                                                                                            value="{{ $payss->id }}"
                                                                                            {{ $resultats->paysid == $payss->id ? 'selected' : '' }}>
                                                                                            {{ $payss->nom }}
                                                                                        </option>
                                                                                    @endforeach
                                                                                </optgroup>
                                                                                ...
                                                                                <optgroup
                                                                                    ...
                                                                                    @foreach ($discipline as $disciplines)
                                                                                        <option
                                                                                            ...
                                                                                            {{ $resultats->disciplineid == $disciplines->id ? 'selected' : '' }}>
                                                                                            {{ $disciplines->nom }}
                                                                                        </option>
                                                                                    @endforeach
                                                                                </optgroup>
                                                    ...
                                                    <div class="modal fade" role="dialog" tabindex="-1"
                                                        id="suppression-modal-{{ $resultats->id }}">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content"
                                                                style="background-color: white">
                                                                <div class="modal-header" style="text-align: left;">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="POST"
                                                                        action="{{ route('supprimer', ['modelName' => 'Resultat', 'id' => $resultats->id]) }}">
                                                                        @csrf
                                                                        @if (Session::has('success'))
                                                                            <div class="alert alert-success">
                                                                                {{ Session::get('success') }}</div>
