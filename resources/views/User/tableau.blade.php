                                    ...
                                    <table class="table my-0" id="dataTable">
                                        ...
                                        <tbody>
                                            @foreach ($mouvement as $mouvements)
                                                <tr>
                                                    <td>{{ $mouvements->discipline }}</td>
                                                    <td>{{ number_format($mouvements->recette_total ?? 0, 2, ',', ' ') }}
                                                    </td>
                                                    <td>{{ number_format($mouvements->depense_total ?? 0, 2, ',', ' ') }}
                                                    </td>
                                                    <td>{{ number_format($mouvements->difference ?? 0, 2, ',', ' ') }}
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
